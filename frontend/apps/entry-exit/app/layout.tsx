...
export const metadata: Metadata = {
  title: 'Premier Green Innovations — Entry / Exit Terminal',
  description: 'Visitor arrival & departure logging terminal for Security & Reception.',
  icons: {
    icon: '/logo.png',
    shortcut: '/logo.png',
    apple: '/logo.png',
  ...
  return (
    <html lang="en" className="light">
      ...
      <body className="min-h-screen bg-[#f8faf9] text-[#1a2522] flex flex-col antialiased selection:bg-[#234D42]/20 selection:text-[#1a2522]">
        <Providers>
          <BrandHeader terminalLabel="Entry / Exit Terminal" />
