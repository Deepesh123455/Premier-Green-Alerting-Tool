...
export const metadata: Metadata = {
  title: 'Premier Green Innovations — Live Dashboard',
  description: 'Real-time operations dashboard for Entry/Exit, Truck Logs, and Incoming Reports.',
  icons: {
    icon: '/logo.png',
    shortcut: '/logo.png',
    apple: '/logo.png',
  ...
  return (
    <html lang="en" className="light">
      ...
      <body className="min-h-screen bg-[#f8faf9] text-[#1a2522] flex flex-col antialiased selection:bg-[#234D42]/20 selection:text-[#1a2522]">
        <Providers>
          <BrandHeader terminalLabel="Live Dashboard" />
